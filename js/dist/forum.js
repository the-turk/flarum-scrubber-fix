...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('the-turk-scrubber-fix', function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'config', function (element, isInitialized, context) {
    var _this = this;

    if (isInitialized) return;
    var initialScrubberBottom = '';
    var footerHeight = $(".scrubberFix").outerHeight(true);
    var bottomApp = parseInt($(".App--discussion").css("padding-bottom"));
    var $scrollParent = $(window);

    var scrollHandler = function scrollHandler() {
      var $leftNavi = _this.$(".DiscussionPage-nav > ul");
